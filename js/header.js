...
const headerElement = document.getElementById('rolling-header');
    const strings = ['12 Artists rescued from the void', 'featuring...', 'dehzer', '/|\\ v /|\\', 'social cred!t card reader', 'terminal glitch', 'digital rips', 'smush', 'marmalade malaise', 'bills board', 'geogen', 'toot', 'CG', 'FUNT', 'Hang out, look around, enjoy yourself!', 'PVC'];
